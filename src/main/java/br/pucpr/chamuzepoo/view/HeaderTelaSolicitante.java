...
public class HeaderTelaSolicitante {

    public static HBox criarNavbarSolicitante() {
        ...
        btnHome.setOnAction(e -> Main.mudarCena(TelaSolicitanteInicial.criarTela()));

        Button btnPropostas = criarBotaoEstilizado("Propostas", "outline-warning");
        ...
        Label saudacao = new Label("Bem-vindo, Solicitante");
        saudacao.setStyle("-fx-text-fill: white; -fx-font-weight: bold;");

        barraDeNavegacao.getChildren().addAll(
                logo, btnHome, btnPropostas, btnServicos, espaco, saudacao, btnPerfil, btnSair
        );
